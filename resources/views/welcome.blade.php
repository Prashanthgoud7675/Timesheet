...
<body style="background-color: whitesmoke">
    ...
    <section style="background-color:#002F6C;">
        ...
        <select style="background-color:#002F6C; color:white;margin-top:2%; margin-bottom:2%; margin-left:13%; border:none">
        ...
        <div class="col-md-10"
            ...
            <div style="background-color:  rgb(212, 212, 215); margin-bottom:3%">
              ...
              <div style="display:flex;">
                ...
                <select style="background-color:whitesmoke;  margin-left:6%; width:30%;font-size:20px; font-weight:600; border-radius:8px;padding-top:8px; padding-bottom:8px">
                  <option value="" >Company Name A-Z</option>
                  @foreach ($data as $i)
                  <option value=" Company_Name " >{{$i->Company_Name}}</option>
                  @endforeach
              </select>
              ...
              <button type="button" class="btn btn-success " style="font-size: 20px; margin-left:80%; width:12%; margin-bottom:2%">Find</button>
            ...
            <table  class="table ">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="color: rgb(49, 143, 243); font-size:17px"> <a href="dashboard"> {{$i->Company_Name}} </a> </td>

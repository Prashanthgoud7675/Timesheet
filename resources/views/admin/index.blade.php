...
<body style="background-color: whitesmoke">
    ...
    <section style="background-color:#002F6C;">
        ...
        <li
            style="background-color:#002F6C; color:white;margin-top:2%; margin-left:10%;list-style:none;font-size:15px;">
    ...
    <section>
        <div class="row justify-content-center">
            <div class="col-md-10"
                ...
                <h3 class="breadcrumb" style="background-color: #1956a4; font-weight:600; color:white"> Add Company <div class="float-right"> <a
                        href="{{ route('depts.create') }}" style="float:right;"> <i class="fa fa-plus-circle"
                            style="float:right; font-size: 25px; color: rgb(212, 212, 215); margin-left:80%;float:left"> </i> </a> </div>
                </h3>
                ...
                <div style="background-color:  rgb(212, 212, 215); margin-bottom:3%">
                    ...
                    <form action="admin " method="GET" role="search">
                        <div style="padding-top:2%; display:flex">
                            ...
                            <h5 style="margin-left:3%;"> <b> Enter Client_ID or Company Name<b>
                            </h5>
                    ...
                    <div style="display:flex;">
                        ...
                        <div style="margin-left: 6%; width:30%;">
                            <select name="filter_country" id="filter_country" class="form-control"
                                ...
                                @foreach ($data as $i)
                                    <option name="country" value="{{ $i->Company_Name }}">{{ $i->Company_Name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <h5 style="margin-left:3%; font-weight:600"> Select the company name </h5>
                        ...
                        <tbody>
                            @forelse ($data as $i)
                                <tr>
                                    ...
                                    <td style="color: rgb(49, 143, 243); font-size:15px"> <a href="">
                                            {{ $i->Company_Name }} </a> </td>
                                    <td style="font-size:15px; color:rgb(133, 125, 125)">{{ $i->Company_Address }}
                                    </td>
                                    <td style="font-size:15px; color:rgb(133, 125, 125)">{{ $i->Next_Check_Date }}
                                    </td>
                                    <td style="font-size:15px; color:rgb(133, 125, 125)">{{ $i->Status }}</td>
                                    <td style="font-size:15px; color:rgb(133, 125, 125)"><a
                                            href="{{ route('depts.edit', $i->id) }}"><i class="fa fa-ellipsis-v"></i>
                                    </td>
                                </tr>
                            @empty

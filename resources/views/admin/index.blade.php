...
<br>
        ...
        <div class="dropdown">
  <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="background-color:#002F6C; color:white;margin-top:2%; margin-bottom:2%; margin-left:10%">
    Employe 
  </button>
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton"  style="margin-left:10%">
    ...
    <a class="dropdown-item" href="filter" >View Employe</a>
    ...
    <section>
        <div class="row justify-content-center">
            <div class="col-md-10"
                ...
                <h3 class="breadcrumb" style="background-color: #1956a4; font-weight:600; color:white">Add Company <a href="{{route('depts.create')}}"> <i
                ...
                <div style="background-color:  rgb(212, 212, 215); margin-bottom:3%">
                    ...
                    <form action="admin " method="GET" role="search">
                        <div  style="padding-top:2%; display:flex">
                          ...
                          <h5 style="margin-left:3%;"> <b> Enter  Company Name and then click Enter <b></h5>

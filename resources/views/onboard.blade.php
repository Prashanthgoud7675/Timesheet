    ...
    <section>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-5" style="background-color: white; border-radius:10px;  box-shadow: 0px 10px 50px rgba(180, 174, 174, 0.7);margin-left:5%">
                ...
                <p style="font-size: 20px; font-weight:600;padding-top:2%">Do you want employee to enter their own personal information</p>
                
                <p style="color: rgb(124, 117, 117)">Letting the employee enter their own info saves you time and helps prevent errors</p>
                ...
                <div style="display: flex; margin-bottom:10%">
                    ...
                    <div style="background-color: white; border-radius:10px;  box-shadow: 0px 10px 50px rgba(180, 174, 174, 0.7); width:250px; margin-left:3%">
                        ...
                        <i style="color: rgb(17, 96, 179); background-color:rgb(205, 225, 245);border-radius:50%; font-size:20px; padding:8px;margin-left:10%; padding-bottom:7%"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-send-fill" viewBox="0 0 16 16" style="margin-bottom: 0%; ">
                        ...
                        <h5>Yes, let them self onboard</h5>

                        <h5 style="color: rgb(124, 117, 117)"> Send them an invitation to Xsilica</h5>
                    ...
                    <div style="background-color: white; border-radius:10px;  box-shadow: 0px 10px 50px rgba(180, 174, 174, 0.7); width:250px;margin-left:12%">
                        ...
                        <h5>No, I'll do the onboarding </h5>

                        <h5 style="color: rgb(124, 117, 117)"> I can fill out all the information </h5>
                        </div>
